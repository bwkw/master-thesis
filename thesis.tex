...
表\ref{table:lan140493-lbn561971-ran3930-rbn15722-fitting}に示すように、Aの組成比0.2の時の、$X$の値を導出することが出来る。

各組成比においても、上記と同様のプロセスを経ることで、$X$の値を導出することが出来る。
本研究においては、Aの組成比を0.02〜0.98に0.02刻みで変化させ、各組成比における$X$を導出する。

図\ref{fig:bi-symmetric}に、Aの組成比とその各組成比における$X$を示す。
...
\newpage
共沸条件は$X=0$であるから、Aの組成比$\approx0.5$で共沸現象が実現されていることが分かる。
