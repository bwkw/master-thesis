...
この初期条件の下、二成分の相互作用が対称な系と非対称な系においてシミュレーションを行う。二成分の相互作用が対称な系においては${\sigma}=1.0$,\,${\varepsilon}=1.0$とし、二成分の相互作用が非対称な系においては${\sigma}=1.0$,\,${\varepsilon}=1.05$とする。どちらの系においても、温度$T=1.0$とし、タイムステップ0.001で4000000実行のシミュレーションを行い、気液共存状態を実現する。
